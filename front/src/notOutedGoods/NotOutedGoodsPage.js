...
import {buyGoods, getCartItems, getCartItemsNotOut, rmOrder, updateOrder} from "../utils/http/OrderController";
...
const NotOutedGoodsPage = (props) => {
    ...
    const asyncGetOrder = () => {
        getCartItemsNotOut().then(commsNew=>{
...
export default NotOutedGoodsPage